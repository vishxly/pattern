...
import IntegrationConstellation from "@/lib/blocks/components/showcase/showcase4";

export const showcase4Registry: LandingComponentGroup = {
  title: "Integration Galaxy",
  description: "A visually stunning landing page showcasing seamless integrations with popular workflow tools.",
  category: "Showcase",
  variants: {
    default: {
      title: "Integration Galaxy",
      description: "A visually stunning landing page showcasing seamless integrations with popular workflow tools.",
      component: IntegrationConstellation,
      image: "/images/blocks/showcase/showcase4.png",
      fallbackImage:
