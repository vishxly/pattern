...
import PricingSection from "../../components/pricing/pricing4";

export const pricing4Registry: LandingComponentGroup = {
  title: "Pricing",
  description: "Flexible pricing for every stage.",
  category: "Pricing",
  variants: {
    default: {
      title: "Pricing",
      ...
      image: "/images/blocks/pricing/pricing4.png",
      fallbackImage:
