...
import ElegantDark404 from "@/lib/blocks/components/notfound/notfound3";

export const notfound3Registry: LandingComponentGroup = {
  title: "Void 404: Elegant Error",
  description: "A stylish 404 page with subtle animations, gradient backgrounds, and clear navigation buttons.",
  category: "Notfound",
  variants: {
    default: {
      title: "Void 404: Elegant Error",
      description: "A stylish 404 page with subtle animations, gradient backgrounds, and clear navigation buttons.",
      component: ElegantDark404,
      image: "/images/blocks/notfound/notfound3.png",
      fallbackImage:
