...
import NotFound from "@/lib/blocks/components/notfound/notfound1";

export const notfound1Registry: LandingComponentGroup = {
  title: "404: Access Denied",
  description: "A stylish 404 page with a rotating loader, custom border, and user authentication information.",
  category: "Notfound",
  variants: {
    default: {
      title: "404: Access Denied",
      description: "A stylish 404 page with a rotating loader, custom border, and user authentication information.",
      component: NotFound,
      image: "/images/blocks/notfound/notfound1.png",
      fallbackImage:
