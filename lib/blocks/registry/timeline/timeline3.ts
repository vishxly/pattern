...
import MinimalCenterTimeline from "../../components/timeline/timeline3";

export const timeline3Registry: LandingComponentGroup = {
  title: "Centered Timeline",
  description: "Centered timeline component for showcasing steps or events.",
  category: "Timeline",
  variants: {
    default: {
      title: "Centered Timeline",
      description:
        "Centered timeline component for showcasing steps or events.",
      component: MinimalCenterTimeline,
      image: "/images/blocks/timeline/timeline3.png",
      fallbackImage:
