...
import CardStackTimeline from "../../components/timeline/timeline4";

export const timeline4Registry: LandingComponentGroup = {
  title: "Card Stack Timeline",
  description:
    "A visually appealing timeline component with card stack design.",
  category: "Timeline",
  variants: {
    default: {
      title: "Card Stack Timeline",
      description:
        "A visually appealing timeline component with card stack design.",
      component: CardStackTimeline,
      image: "/images/blocks/timeline/timeline4.png",
      fallbackImage:
