...
export const login1Registry: LandingComponentGroup = {
  title: "Login Form",
  ...
  variants: {
    default: {
      ...
      description: "A simple login form with email and password fields.",
      component: Login,
      image: "/images/blocks/form/login1.png",
      fallbackImage: "/placeholder.svg?height=300&width=400&text=Login+Form",
...
const Login = () => {
  ...
  const handleRegister = () => {
    // Handle registration logic here, e.g., redirect to a register page
