...
import Home from "@/lib/blocks/components/landing/landing5";

export const landing5Registry: LandingComponentGroup = {
  title: "Monolith: Build with Impact",
  description: "A high-performance landing page showcasing a developer toolkit with interactive elements, pricing tiers, and testimonials.",
  category: "Landing",
  variants: {
    default: {
      title: "Monolith: Build with Impact",
      description: "A high-performance landing page showcasing a developer toolkit with interactive elements, pricing tiers, and testimonials.",
      component: Home,
      image: "/images/blocks/landing/landing5.png",
      fallbackImage:
