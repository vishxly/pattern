...
import Home from "@/lib/blocks/components/landing/landing9";

export const landing9Registry: LandingComponentGroup = {
  title: "Chroma: Data Clarity",
  description: "A landing page showcasing a data analytics platform with interactive elements, smooth animations, and clear pricing.",
  category: "Landing",
  variants: {
    default: {
      title: "Chroma: Data Clarity",
      description: "A landing page showcasing a data analytics platform with interactive elements, smooth animations, and clear pricing.",
      component: Home,
      image: "/images/blocks/landing/landing9.png",
      fallbackImage:
