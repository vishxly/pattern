...
import Landing2 from "@/lib/blocks/components/landing/landing2";

export const landing2Registry: LandingComponentGroup = {
  title: "OrbitDeploy: Launch & Scale",
  description: "A modern landing page showcasing a cloud platform for deploying and scaling web applications, featuring animation and interactive elements.",
  category: "Landing",
  variants: {
    default: {
      title: "OrbitDeploy: Launch & Scale",
      description: "A modern landing page showcasing a cloud platform for deploying and scaling web applications, featuring animation and interactive elements.",
      component: Landing2,
      image: "/images/blocks/landing/landing2.png",
      fallbackImage:
