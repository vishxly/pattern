...
import ArcLandingPage from "@/lib/blocks/components/landing/landing10";

export const landing10Registry: LandingComponentGroup = {
  title: "Arc: Modern Software OS",
  description: "A unified platform for software teams, streamlining planning, development, deployment, and security.",
  category: "Landing",
  variants: {
    default: {
      title: "Arc: Modern Software OS",
      description: "A unified platform for software teams, streamlining planning, development, deployment, and security.",
      component: ArcLandingPage,
      image: "/images/blocks/landing/landing10.png",
      fallbackImage:
