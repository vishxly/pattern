...
import Landing1 from "@/lib/blocks/components/landing/landing4";

export const landing4Registry: LandingComponentGroup = {
  title: "Aura: AI-Powered Investing",
  description: "A modern investment landing page with AI insights, automated portfolios, and flexible pricing.",
  category: "Landing",
  variants: {
    default: {
      title: "Aura: AI-Powered Investing",
      description: "A modern investment landing page with AI insights, automated portfolios, and flexible pricing.",
      component: Landing1,
      image: "/images/blocks/landing/landing4.png",
      fallbackImage:
