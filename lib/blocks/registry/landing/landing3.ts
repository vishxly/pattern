...
import Landing3 from "@/lib/blocks/components/landing/landing3";

export const landing3Registry: LandingComponentGroup = {
  title: "Arc: Digital Precision",
  description: "A modern landing page showcasing key features, workflow, pricing, and testimonials with smooth animations.",
  category: "Landing",
  variants: {
    default: {
      title: "Arc: Digital Precision",
      description: "A modern landing page showcasing key features, workflow, pricing, and testimonials with smooth animations.",
      component: Landing3,
      image: "/images/blocks/landing/landing3.png",
      fallbackImage:
