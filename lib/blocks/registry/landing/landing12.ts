...
import NovaLandingPage from "@/lib/blocks/components/landing/landing12";

export const landing12Registry: LandingComponentGroup = {
  title: "Nova: AI-Native Insights",
  description: "A modern landing page showcasing an AI-powered data intelligence platform with interactive visualizations and a smooth user experience.",
  category: "Landing",
  variants: {
    default: {
      title: "Nova: AI-Native Insights",
      description: "A modern landing page showcasing an AI-powered data intelligence platform with interactive visualizations and a smooth user experience.",
      component: NovaLandingPage,
      image: "/images/blocks/landing/landing12.png",
      fallbackImage:
