...
import Home from "@/lib/blocks/components/landing/landing7";

export const landing7Registry: LandingComponentGroup = {
  title: "Synapse: Data in Motion",
  description: "A landing page showcasing a workflow unification platform with interactive elements, pricing tiers, and testimonials.",
  category: "Landing",
  variants: {
    default: {
      title: "Synapse: Data in Motion",
      description: "A landing page showcasing a workflow unification platform with interactive elements, pricing tiers, and testimonials.",
      component: Home,
      image: "/images/blocks/landing/landing7.png",
      fallbackImage:
        "/placeholder.svg?height=300&width=400&text=Landing+Page",
      code: `// lib/blocks/components/landing/landing7.tsx
