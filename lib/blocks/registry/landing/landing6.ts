...
import CyberCoreLandingPage from "@/lib/blocks/components/landing/landing6";

export const landing6Registry: LandingComponentGroup = {
  title: "Cyber-Core: DevSecOps",
  description: "A unified DevSecOps platform embedding security from code to cloud, featuring AI-powered remediation and a modern UI.",
  category: "Landing",
  variants: {
    default: {
      title: "Cyber-Core: DevSecOps",
      description: "A unified DevSecOps platform embedding security from code to cloud, featuring AI-powered remediation and a modern UI.",
      component: CyberCoreLandingPage,
      image: "/images/blocks/landing/landing6.png",
      fallbackImage:
