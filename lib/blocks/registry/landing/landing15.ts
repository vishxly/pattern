...
import HomePage from "@/lib/blocks/components/landing/landing15";

export const landing15Registry: LandingComponentGroup = {
  title: "Stellar: Analytics Reimagined",
  description: "A modern data analytics landing page with interactive features, smooth animations, and clear pricing.",
  category: "Landing",
  variants: {
    default: {
      title: "Stellar: Analytics Reimagined",
      description: "A modern data analytics landing page with interactive features, smooth animations, and clear pricing.",
      component: HomePage,
      image: "/images/blocks/landing/landing15.png",
      fallbackImage:
