...
import Home from "@/lib/blocks/components/landing/landing11";

export const landing11Registry: LandingComponentGroup = {
  title: "Atlas: Build with Speed",
  description: "A modern landing page showcasing a developer-first API, interactive code comparison, and clear pricing tiers.",
  category: "Landing",
  variants: {
    default: {
      title: "Atlas: Build with Speed",
      description: "A modern landing page showcasing a developer-first API, interactive code comparison, and clear pricing tiers.",
      component: Home,
      image: "/images/blocks/landing/landing11.png",
      fallbackImage:
