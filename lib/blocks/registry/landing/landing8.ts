...
import Landing8 from "@/lib/blocks/components/landing/landing8";

export const landing8Registry: LandingComponentGroup = {
  title: "Momentum: Team Workspace",
  description: "A modern landing page showcasing a collaborative kanban board, interactive features, and flexible pricing.",
  category: "Landing",
  variants: {
    default: {
      title: "Momentum: Team Workspace",
      description: "A modern landing page showcasing a collaborative kanban board, interactive features, and flexible pricing.",
      component: Landing8,
      image: "/images/blocks/landing/landing8.png",
      fallbackImage:
