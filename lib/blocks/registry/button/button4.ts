...
import Button from "../../components/button/button4";

export const button4Registry: LandingComponentGroup = {
  title: "Deploy Now",
  description: "A button with a deploy now text",
  category: "Button",
  variants: {
    default: {
      title: "Deploy Now",
      description: "A button with a deploy now text",
      component: Button,
      image: "/images/blocks/button/button4.png",
      fallbackImage:
