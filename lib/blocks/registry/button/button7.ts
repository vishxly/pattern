...
import Button from "../../components/button/button7";

export const button7Registry: LandingComponentGroup = {
  title: "Star Repository",
  description: "A button with a star icon",
  ...
  variants: {
    default: {
      ...
      description: "A button with a star icon",
      component: Button,
      image: "/images/blocks/button/button7.png",
      fallbackImage:
