...
import Button from "../../components/button/button8";

export const button8Registry: LandingComponentGroup = {
  title: "Launch Framer",
  description: "A button with a gradient effect",
  category: "Button",
  variants: {
    default: {
      title: "Launch Framer",
      description: "A button with a gradient effect",
      component: Button,
      image: "/images/blocks/button/button8.png",
      fallbackImage:
