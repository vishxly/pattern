...
import TaskerLanding from "../../components/hero/tasker";

export const taskerRegistry: LandingComponentGroup = {
  title: "Tasker Landing Page",
  description:
    "A modern and sleek landing page design with a focus on user engagement and conversion.",
  category: "Hero",
  variants: {
    default: {
      title: "Tasker Landing Page",
      description:
        "A modern and sleek landing page design with a focus on user engagement and conversion.",
      component: TaskerLanding,
      image: "/images/blocks/hero/tasker.png",
      fallbackImage:
        "/placeholder.svg?height=300&width=400&text=Footer+Section",
      code: `export default function TaskerLanding() {
  return (
