// lib/blocks/registry/designify-registry.ts

import DesignifyLanding from "../../components/hero/designify";
import { LandingComponentGroup } from "@/lib/blocks/landing-registry";

export const designifyRegistry: LandingComponentGroup = {
  title: "Designify Landing",
  description: "Clean, calm design with adaptive, automation-focused layout.",
  category: "Hero",
  variants: {
    default: {
      title: "Designify Section",
      description: "A comprehensive Designify with links and social media.",
      component: DesignifyLanding,
      image: "/images/blocks/hero/designify.png",
      fallbackImage:
