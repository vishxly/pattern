...
import ZenoLandingPage from "../../components/hero/zeno";

export const zenoRegistry: LandingComponentGroup = {
  ...
  variants: {
    default: {
      ...
      description:
        "A modern and sleek landing page design with a focus on user engagement and conversion.",
      component: ZenoLandingPage,
      image: "/images/blocks/hero/zeno.png",
      fallbackImage:
