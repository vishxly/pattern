...
import InvistraLanding from "../../components/hero/invistra";

export const invistraRegistry: LandingComponentGroup = {
  title: "InvistraLanding",
  description: "A modern landing page with a focus on invisible protection and privacy.",
  category: "Hero",
  variants: {
    default: {
      title: "InvistraLanding",
      description: "A modern landing page with a focus on invisible protection and privacy.",
      component: InvistraLanding,
      image: "/images/blocks/hero/invistra.png",
      fallbackImage:
        "/placeholder.svg?height=300&width=400&text=Footer+Section",
      code: `export default function InvistraLanding() {
    return (
