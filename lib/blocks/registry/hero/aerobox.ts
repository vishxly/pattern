// lib/blocks/registry/footer-registry.ts

import { LandingComponentGroup } from "@/lib/blocks/landing-registry";
import AeroBoxLanding from "../../components/hero/aerobox";

export const aeroboxRegistry: LandingComponentGroup = {
  title: "Aerobox",
  description:
    "AeroBox features a sleek dark layout with glowing blue accents, emphasizing secure and accessible cloud storage.",
  category: "Hero",
  variants: {
    default: {
      title: "Aerobox",
      description:
        "AeroBox features a sleek dark layout with glowing blue accents, emphasizing secure and accessible cloud storage.",
      component: AeroBoxLanding,
      image: "/images/blocks/hero/aerobox.png",
      fallbackImage:
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto bg-black ring-1 ring-white/10 shadow-2xl">
        ...
        <footer className="px-8 py-12 border-t border-gray-800/50 text-center text-gray-400">
          <p>© 2024 AeroBox. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
