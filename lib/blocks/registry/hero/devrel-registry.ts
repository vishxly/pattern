// lib/blocks/registry/devrel-registry.ts


import { LandingComponentGroup } from "@/lib/blocks/landing-registry";
import DevRelBridgeLanding from "@/lib/blocks/components/hero/devrel";

export const devrelRegistry: LandingComponentGroup = {
  title: "Devrel",
  description: "DevRelBridge uses a crisp, professional layout with strong contrast, large headline text, and prominent blue CTAs for a clean, enterprise feel.",
  category: "Hero",
  variants: {
    default: {
      title: "Devrel",
      description: "DevRelBridge uses a crisp, professional layout with strong contrast, large headline text, and prominent blue CTAs for a clean, enterprise feel.",
      component: DevRelBridgeLanding,
      image: "/images/blocks/hero/devrel.png",
      fallbackImage:
