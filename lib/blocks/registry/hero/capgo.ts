// lib/blocks/registry/capgo.ts

import { LandingComponentGroup } from "@/lib/blocks/landing-registry";
import CapgoLanding from "@/lib/blocks/components/hero/capgo";

export const capgoRegistry: LandingComponentGroup = {
  title: "Capgo",
  description:  "Capgo is a platform that allows you to push updates to your CapacitorJS apps instantly, without the need for App Store approvals or version bumps.",
  category: "Hero",
  variants: {
    default: {
      title: "Capgo  ",
      description:  "Capgo is a platform that allows you to push updates to your CapacitorJS apps instantly, without the need for App Store approvals or version bumps.",
      component: CapgoLanding,
      image: "/images/blocks/hero/capgo.png",
      fallbackImage:
