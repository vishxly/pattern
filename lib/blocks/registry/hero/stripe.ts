// lib/blocks/registry/stripe.ts

import { LandingComponentGroup } from "@/lib/blocks/landing-registry";
import StripeHeroSection from "../../components/hero/stripe";

export const stripeRegistry: LandingComponentGroup = {
  title: "Stripe",
  description: "A hero section with a Stripe theme.",
  category: "Hero",
  variants: {
    default: {
      title: "Stripe",
      description: "A hero section with a Stripe theme.",
      component: StripeHeroSection,
      image: "/images/blocks/hero/stripe.png",
      fallbackImage:
