import Footer from "@/lib/blocks/components/footer/footer3";
import { LandingComponentGroup } from "@/lib/blocks/landing-registry";

export const footer3Registry: LandingComponentGroup = {
  title: "ScaleX Footer Section",
  description: " A modern footer with accordion FAQs and links.",
  category: "Footer",
  variants: {
    default: {
      title: "ScaleX Footer Section",
      description: " A modern footer with accordion FAQs and links.",
      component: Footer,
      image: "/images/blocks/footer/footer3.png",
      fallbackImage:
