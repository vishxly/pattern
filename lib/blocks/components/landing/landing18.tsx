"use client"; // Required for Framer Motion hooks like useInView
  ...
  const features: Feature[] = [
    {
      ...
      desc: "Every component is designed with meticulous attention to detail.",
      icon: "🎨",
    },
    {
      title: "Fully Responsive",
      desc: "Flawless performance on any screen size, from mobile to desktop.",
      icon: "📱",
    },
    {
      title: "Dark Mode Ready",
      desc: "Beautifully styled for both light and dark themes out of the box.",
      icon: "🌙",
    },
  ];
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        "Zero UI has accelerated our development process by at least 40%. The components are intuitive, well-documented, and simply beautiful. A true game-changer.",
    ...
    },
    {
      ...
      quote:
        "As a designer, I appreciate the thought and craft that went into this. It's aesthetically pleasing and incredibly easy to customize to fit our brand. Highly recommended!",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="#"
                className="hidden md:inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white dark:text-black bg-black dark:bg-white rounded-full"
              >
                Get Started
              </Link>
            </motion.div>
      ...
      <main>
          ...
          >
            ...
            <div className="rounded-[24px] border border-neutral-200 bg-white p-2 dark:border-neutral-700 dark:bg-black">
              <Image
                ...
                src="https://cdn.dribbble.com/userupload/3698791/file/original-5aca281d214536b20fb97f7dc30ffba3.jpg?resize=1504x1128&vertical=center"
              />
            </div>
          </motion.div>
        </AnimatedSection>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <motion.div variants={FADE_IN_UP}>
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
                Zero UI provides the best components to build modern, beautiful
        ...
        <AnimatedSection className="py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            ...
            >
              Join thousands of developers and designers building incredible
              experiences. Get started with Zero UI today and build better,
              faster.
            </motion.p>
