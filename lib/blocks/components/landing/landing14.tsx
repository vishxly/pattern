            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                     <div className="relative rounded-xl shadow-2xl shadow-slate-200 border border-slate-200 bg-white p-2">
                        <Image 
                            src="https://www.tryprofound.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdashboard.ccad73b0.png&w=3840&q=100&dpl=dpl_EJ8PPn1i1wKf4TM9kr2eurS1RC8o" 
                            width={2400} 
                            height={1480} 
                            ...
                            activeFeature.id === feature.id ? 'bg-slate-100' : 'bg-transparent'
                             ...
                             <feature.Icon className={
                                activeFeature.id === feature.id 
                                    ? 'h-8 w-8 mb-3 transition-colors duration-300 text-green-500' 
                                    : 'h-8 w-8 mb-3 transition-colors duration-300 text-slate-400'
                             } />
