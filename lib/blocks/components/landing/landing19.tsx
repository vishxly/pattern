  ...
  return (
    <>
      <header className="shadow-inner sticky top-5 z-40 mx-auto flex w-full items-center justify-between rounded-2xl border p-2 px-4 transition-all duration-300 sm:w-[95%] md:w-[70%] lg:w-[75%] lg:px-2 bg-[var(--bg-white-0)]/33 max-w-5xl border-neutral-alpha-24 backdrop-blur-lg lg:max-w-screen-md">
        <a
          className="flex items-center font-mono text-label-lg font-bold"
          href="/"
        >
          <svg
            width="512"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_4150_87"
                ></feBlend>
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_4150_87"
                  result="shape"
                ></feBlend>
              </filter>
              <filter
                id="filter1_d_4150_87"
                x="127.625"
                y="93.2822"
                width="282.656"
                height="336.551"
        ...
        <nav
          ...
          dir="ltr"
          className="relative z-10 max-w-max flex-1 items-center justify-center mx-auto hidden lg:block"
        >
          <div style={{ position: "relative" }}>
            ...
            >
              <li>
                <button
                  id="radix-:Rccv9ba:-trigger-radix-:Rbccv9ba:"
                  data-state="closed"
                  aria-expanded="false"
                  aria-controls="radix-:Rccv9ba:-content-radix-:Rbccv9ba:"
              ...
              <li className="flex items-center gap-2">
                <a
                  className="text-base px-2 text-text-sub-600 hover:text-text-strong-950"
                  data-radix-collection-item=""
                  href="/features"
                >
                  Features
      ...
      <div
        className="pointer-events-none absolute left-0 right-0 top-0 h-screen overflow-hidden"
        style={{ opacity: 1 }}
      >
        <div
          className="absolute right-[-32rem] top-[-40rem] z-0 flex rotate-[-20deg] skew-x-[-40deg] skew-y-[-40deg] gap-40 blur-[4rem] lg:right-[-24rem]"
          style={{ opacity: 1 }}
        >
          <div
            className="h-80 w-40 bg-gradient-to-b from-white to-orange-500"
            style={{ opacity: 0.6, transform: "none" }}
          ></div>
          <div
            className="h-80 w-40 bg-gradient-to-b from-white to-orange-500"
            style={{ opacity: 0.6, transform: "none" }}
        ...
        <div
          className="absolute right-[-47rem] top-[-48rem] z-0 flex rotate-[-20deg] skew-x-[-40deg] skew-y-[-40deg] gap-40 blur-[4rem] lg:right-[-40rem]"
          style={{ opacity: 1 }}
        >
          <div
            className="h-80 w-40 bg-gradient-to-b from-white to-pink-300"
            style={{ opacity: 0.6, transform: "none" }}
          ></div>
          <div
            className="h-80 w-40 bg-gradient-to-b from-white to-pink-300"
        ...
        <div
          className="absolute right-[-61rem] top-[-60rem] z-0 flex rotate-[-20deg] skew-x-[-40deg] skew-y-[-40deg] gap-40 blur-[4rem] lg:right-[-56rem]"
          style={{ opacity: 1 }}
        >
          <div
            className="h-[400px] w-40 bg-gradient-to-b from-white to-purple-500"
            style={{ opacity: 0.6, transform: "none" }}
          ></div>
          <div
            className="h-[400px] w-40 bg-gradient-to-b from-white to-purple-500"
            ...
            >
              <div className="group relative mx-auto inline-flex cursor-pointer items-center justify-center rounded-full px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]">
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-chevron-right ml-1 size-4 stroke-neutral-500 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5"
                >
              ...
              <div className="flex w-full flex-col items-center justify-center gap-2 space-y-4 md:space-y-0">
                <div className="glass-border-button shadow-sm group relative h-12 cursor-pointer rounded-xl bg-white/10 shadow-black/5">
                  <div className="glass-border absolute -left-[3px] -top-[3px] z-0 h-[calc(100%+6px)] w-[calc(100%+6px)] overflow-hidden rounded-xl after:absolute after:left-0 after:top-0 after:h-full after:w-full after:rounded-xl after:border-[0.5px] after:border-white/20 after:content-['']">
                    <div
                      className="absolute left-[-42px] top-[-90px] aspect-square h-auto w-[150%] animate-spin blur [animation-duration:5s]"
                      style={{
                        background:
                          "conic-gradient(from 90deg at 50% 50%, rgba(250, 115, 25, 0.12) 0, rgba(250, 115, 25, 0.12) 10%, #fa7319 20%, rgba(250, 115, 25, 0.12) 30%, rgba(250, 115, 25, 0.12) 60%, #fa7319 70%, rgba(250, 115, 25, 0.12) 80%, rgba(250, 115, 25, 0.12) 100%)",
                      }}
                    ></div>
                  </div>
                  <div className="z-10 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl px-8 py-1 font-medium bg-gradient-to-br from-neutral-950 to-neutral-950 backdrop-blur-2xl dark:from-white dark:via-white/80 dark:to-white group-hover:from-black/90 group-hover:to-black/70 dark:group-hover:from-white/90 dark:group-hover:to-white">
                    <div className="flex items-center justify-center gap-2 text-text-white-0 transition-transform duration-100 ease-in-out group-hover:scale-105">
                      <a
                        ...
                        target="_blank"
                        href="https://app.typepulse.ai/auth/sign-up"
                      ...
                      >
                        ...
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-arrow-right ml-2 size-5 transition-transform group-hover/arrow:translate-x-1"
                        >
            ...
            <div className="group relative rounded-2xl border border-white/10 bg-[linear-gradient(116.91deg,#e9358f3d,#e3a5724f)] p-2 shadow-[inset_0_.450581px_#ffffff4d,0_0_36.0465px_#ffffff0f]">
              ...
              <div className="relative mx-auto flex w-full items-center rounded-2xl leading-none">
                <div className="group relative cursor-pointer">
                  <Image
                    src="https://www.typepulse.ai/app-bg-dark.webp"
                    alt="Hero Video Thumbnail"
                    width={1920}
                    height={1080}
                    className="shadow-lg w-full rounded-2xl border border-[#ffffff1a] transition-all duration-200 ease-out group-hover:brightness-[0.8]"
                  />
                  ...
                  <div className="relative flex h-full w-full items-center justify-center">
                    <div
                      style={{
                        ...
                        backgroundImage:
                          'url("data:image/svg+xml,%3csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22126%22 height=%22126%22%3e%3cpath id=%22a%22 d=%22M126 0v21.584L21.584 126H0v-17.585L108.415 0H126Zm0 108.414V126h-17.586L126 108.414Zm0-84v39.171L63.585 126H24.414L126 24.414Zm0 42v39.17L105.584 126h-39.17L126 66.414ZM105.586 0 0 105.586V66.415L66.415 0h39.171Zm-42 0L0 63.586V24.415L24.415 0h39.171Zm-42 0L0 21.586V0h21.586Z%22 fill=%22%23888%22 fill-rule=%22evenodd%22/%3e%3c/svg%3e")',
                      }}
              ...
              <div className="absolute left-1/2 top-[-36%] z-[-1] w-full max-w-none -translate-x-1/2 transform overflow-hidden">
                <Image
                  ...
                  width={1920}
                  height={1080}
                  className="h-auto w-full min-w-[100vw] object-cover brightness-110 filter sm:min-w-full"
                />
              </div>
            </div>
          </div>
      ...
      <section
        id="features"
        className="container mx-auto max-w-screen-md px-4 pt-24 sm:px-0 sm:pt-32 xl:max-w-screen-lg 2xl:max-w-screen-xl"
      >
        <h2 className="mb-2 text-center text-label-lg tracking-wider text-primary-base">
          POWERFUL FEATURES
        </h2>
        <h2 className="text-white-to-orange-lighter mb-4 text-center font-serif text-title-h3 md:text-title-h2">
          Writing Like Never Before
        </h2>
        <h3 className="text-xl mx-auto mb-8 text-center text-text-sub-600 md:w-1/2">
          Features built to enhance your writing flow.
        </h3>
            ...
            <div className="group relative col-span-3 flex w-full flex-col justify-between overflow-hidden rounded-xl bg-bg-white-0 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
              <div className="z-10 flex transform-gpu flex-col gap-1 p-8 pb-0 transition-all duration-300">
                <div className="flex h-[300px] flex-col overflow-y-auto rounded-lg border border-stroke-soft-200 bg-bg-white-0 p-8">
                  <h1 className="mb-2 text-paragraph-md font-semibold">
                    Rewrite as a Twitter Post
                  </h1>
                  <div style={{ opacity: 1 }}>
                    <p
                      id="initial-paragraph"
                      className="py-2 text-paragraph-sm transition-all duration-300"
                      style={{ transform: "none" }}
                    >
                      <span className="block sm:hidden">
                        Steve Jobs famously said customers don&apos;t know what
                        they want until you show it to them. The best products
                        use customer requests to organize feedback and
                        understand real needs.
                      </span>
                      <span className="hidden sm:block">
                        Steve Jobs famously said customers don&apos;t know what
                        they want until you show it to them. The best products
                        blend vision with customer feedback. Their Customer
                        Requests feature organizes fragmented feedback, helping
                        teams interpret real needs rather than just tallying
                        feature requests. This approach ensures product
                        decisions are informed by genuine customer problems, not
                        just explicit asks, especially as companies scale.
                      </span>
                    </p>
                  </div>
                  <div
                    id="command-interface"
                    className="mt-4 flex flex-col gap-1 rounded-xl border border-stroke-soft-200"
                    ...
                    <div className="relative">
                      <div className="group relative flex w-full overflow-hidden bg-bg-white-0 text-text-strong-950 transition duration-200 ease-out divide-x divide-stroke-soft-200 before:absolute before:inset-0 before:ring-1 before:ring-inset before:pointer-events-none before:rounded-[inherit] before:transition before:duration-200 before:ease-out hover:shadow-none has-[input:disabled]:shadow-none has-[input:disabled]:before:ring-transparent rounded-10 hover:[&:not(:has(input:focus)):has(>:only-child)]:before:ring-transparent shadow-none before:ring-transparent has-[input:focus]:shadow-none has-[input:focus]:before:ring-transparent">
                        <label className="group/input-wrapper flex w-full cursor-text items-center bg-bg-white-0 transition duration-200 ease-out hover:[&:not(&amp;:has(input:focus))]:bg-bg-weak-50 has-[input:disabled]:pointer-events-none has-[input:disabled]:bg-bg-weak-50 gap-2 px-3">
                          <input
                            type="text"
                            className="w-full bg-transparent bg-none text-paragraph-sm text-text-strong-950 outline-none transition duration-200 ease-out placeholder:select-none placeholder:text-text-soft-400 placeholder:transition placeholder:duration-200 placeholder:ease-out group-hover/input-wrapper:placeholder:text-text-sub-600 focus:outline-none group-has-[input:focus]:placeholder:text-text-sub-600 disabled:text-text-disabled-300 disabled:placeholder:text-text-disabled-300 h-10"
                            placeholder="What do you want to write about? or select an AI Agent to get started."
                            value=""
                          />
                        </label>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-1">
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 rounded-lg border border-stroke-soft-200 bg-bg-white-0 px-3 py-1.5">
                          ...
                          <select
                            className="cursor-pointer border-none bg-transparent text-paragraph-xs outline-none"
                            defaultValue="Pulser Agent"
                          >
                        ...
                        <div className="hidden items-center gap-2 sm:flex">
                          <button
                            ...
                            data-state="checked"
                            value="on"
                            className="group/switch block h-5 w-8 shrink-0 p-0.5 outline-none focus:outline-none"
                          >
                            <div className="h-4 w-7 rounded-full bg-bg-soft-200 p-0.5 outline-none transition duration-200 ease-out group-hover/switch:bg-bg-sub-300 group-focus-visible/switch:bg-bg-sub-300 group-active/switch:bg-bg-soft-200 group-data-[state=checked]/switch:bg-primary-base group-hover:data-[state=checked]/switch:bg-primary-darker group-active:data-[state=checked]/switch:bg-primary-base group-focus/switch:outline-none">
                              <span
                                data-state="checked"
                                className="pointer-events-none relative block size-3 transition-transform duration-200 ease-out data-[state=checked]:translate-x-3 before:absolute before:inset-y-0 before:left-1/2 before:w-3 before:-translate-x-1/2 before:rounded-full before:bg-static-white before:[mask:--mask] after:absolute after:inset-y-0 after:left-1/2 after:w-3 after:-translate-x-1/2 after:rounded-full after:shadow-switch-thumb group-active/switch:scale-[.833]"
                                style={
                                  {
                                    "--mask":
              ...
              <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-8 transition-all duration-300">
                <div className="relative h-8 md:h-10">
                  <h3
                    className="absolute inset-0 font-serif text-title-h5 font-semibold text-text-strong-950 md:text-title-h4"
                    style={{ opacity: 1, filter: "blur(0px)" }}
                  >
                    Writing Flow
                  </h3>
                </div>
                <p className="max-w-lg text-text-sub-600">
                  Effortlessly generate, organize, and elevate your content with
                  our powerful prebuilt AI agents.
                </p>
              </div>
                ...
                <div className="flex h-[300px] flex-col gap-8 overflow-y-auto rounded-lg border border-stroke-soft-200 bg-bg-white-0 p-4">
                    ...
                    <div className="flex gap-3 justify-end">
                      <div className="rounded-lg p-2 text-text-strong-950 bg-bg-weak-50 dark:bg-bg-soft-200 prose break-words whitespace-normal text-paragraph-xs">
                        <div className="text-sm">
                          Search reddit for &quot;Grok 4&quot;, How people say
                          it?
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <button className="cursor-pointer pointer-events-auto flex items-center gap-2 text-paragraph-sm text-primary-base">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-sparkle size-4 text-primary-base"
                        >
                          <path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"></path>
                        </svg>
                        Show reasoning
                      ...
                      <div
                        className="overflow-hidden transition-[max-height] duration-150 ease-out border-l-2 border-stroke-soft-200 px-2 !text-paragraph-xs"
                        style={{ maxHeight: "0px" }}
                      >
                        <div className="text-muted-foreground prose prose-sm !text-paragraph-xs dark:prose-invert">
                          <div className="text-sm">
                            The user wants me to search Reddit for &quot;Grok
                            4&quot; to see what people are saying about it. I
                            should use the reddit_scraper function to search for
                            Grok 4 on Reddit and see what discussions and
                  ...
                  <div style={{ opacity: 1, transform: "none" }}>
                    <div className="flex gap-3 items-start justify-start !gap-1">
                      ...
                      <div className="rounded-lg p-2 text-text-strong-950 bg-bg-weak-50 dark:bg-bg-soft-200 prose break-words whitespace-normal text-paragraph-xs">
                        <div className="text-sm">
                          Reddit users praise Grok 4 for strong coding, math,
                          and search skills, comparing it favorably to ChatGPT
                          4.1 and others. It&apos;s used in travel, education,
                          and finance but faces access issues in Europe and
                          payment problems. Opinions on cost versus benefits are
                          mixed, with overall positive views on its technical
                          abilities but concerns about price and accessibility.
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-8 transition-all duration-300">
                <div className="relative h-8 md:h-10">
                  <h3
                    ...
                    style={{ opacity: 1, filter: "blur(0px)" }}
                  >
                    Vibe Writing with AI Agents
                  </h3>
                </div>
                <p className="max-w-lg text-text-sub-600">
                  AI Chats lets you vibe writing with AI agents, and the agents
                  can access your documents and libraries.
                </p>
              </div>
            </div>
          </div>
          <div className="col-span-12 sm:col-span-6 2xl:col-span-5">
            <div className="group relative col-span-3 flex h-full w-full flex-col justify-between overflow-hidden rounded-xl bg-bg-white-0 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
                ...
                <div className="flex h-[300px] flex-col gap-8 overflow-y-auto rounded-lg border border-stroke-soft-200 p-4">
                  ...
                  >
                    <div
                      ...
                      className="relative isolate grid w-full auto-cols-fr grid-flow-col gap-1 rounded-10 bg-bg-weak-50 p-1"
                      tabIndex={0}
                      data-orientation="horizontal"
                      style={{ outline: "none" }}
                    >
                      <button
                        ...
                        role="tab"
                        aria-selected="true"
                        aria-controls="radix-:Rbh4v9ba:-content-pdf"
                        data-state="active"
                        id="radix-:Rbh4v9ba:-trigger-pdf"
                        className="peer relative z-10 h-7 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950"
                        tabIndex={-1}
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                      >
                      ...
                      <button
                        ...
                        role="tab"
                        aria-selected="false"
                        aria-controls="radix-:Rbh4v9ba:-content-link"
                        data-state="inactive"
                        id="radix-:Rbh4v9ba:-trigger-link"
                        className="peer relative z-10 h-7 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950"
                        tabIndex={-1}
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                      ...
                      <div
                        className="absolute inset-y-1 left-0 -z-10 rounded-3xl shadow-toggle-switch transition-transform duration-300"
                        style={{
                    ...
                    <div
                      ...
                      data-orientation="horizontal"
                      role="tabpanel"
                      aria-labelledby="radix-:Rbh4v9ba:-trigger-pdf"
                      id="radix-:Rbh4v9ba:-content-pdf"
                      tabIndex={0}
                      className="mt-4"
                      ...
                      <label className="flex w-full cursor-pointer flex-col items-center gap-5 rounded-xl border border-dashed border-stroke-sub-300 bg-bg-white-0 p-8 text-center transition duration-200 ease-out hover:bg-bg-weak-50 h-full hover:border-primary-base">
                        ...
                        >
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-cloud-upload size-6 text-text-sub-600"
                          >
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="text-paragraph-xs text-text-sub-600">
                              PDF formats, up to 20 MB.
                            </div>
                          </div>
                          <div className="inline-flex h-8 items-center justify-center gap-2.5 whitespace-nowrap rounded-lg bg-bg-white-0 px-2.5 text-label-sm text-text-sub-600 pointer-events-none ring-1 ring-inset ring-stroke-soft-200 mt-4">
                            Browse File
                          </div>
                        </div>
                      </label>
                    ...
                    <div
                      ...
                      data-orientation="horizontal"
                      role="tabpanel"
                      aria-labelledby="radix-:Rbh4v9ba:-trigger-link"
                      hidden
                      id="radix-:Rbh4v9ba:-content-link"
                      tabIndex={0}
                      className="mt-4"
                    ></div>
                  </div>
              ...
              <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-8 transition-all duration-300">
                ...
                <p className="max-w-lg text-text-sub-600">
                  Build your knowledge base from your PDF, Website URL. And AI
                  agents can use it to write better.
                </p>
              </div>
              <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-[#fa7319]/[.024]"></div>
            </div>
          ...
          <div className="col-span-12 2xl:col-span-7">
            <div className="group relative col-span-3 flex w-full flex-col justify-between overflow-hidden rounded-xl bg-bg-white-0 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
              <div className="relative m-8 mb-0 h-[300px] w-[calc(100%-64px)] rounded-lg border border-stroke-soft-200 p-8">
                <h1 className="mb-4 border-b border-stroke-soft-200 pb-4 text-paragraph-lg font-semibold">
                  What is MCP (Model Context Protocol)?
                </h1>
                <p className="hidden py-2 text-paragraph-sm sm:block">
                  Model Context Protocol (MCP) is an open protocol that enables
                  LLMs to access external tools and data sources.
                </p>
                <p
                  className="text-paragraph-sm text-primary-base"
                  style={{ opacity: 1 }}
                >
                  <span className="block sm:hidden">
                    Model Context Protocol (MCP) is an open protocol that
                    enables LLMs to access external tools and data sources.
                  </span>
                  <span className="hidden sm:block">
                    MCP is an open protocol that standardizes how applications
                    provide context to LLMs. Think of MCP like a USB-C port for
                    AI applications. Just as USB-C provides a standardized way
                    to connect your devices to various peripherals and
                    accessories, MCP provides a standardized way to connect AI
                    models to different data sources and tools.
                  </span>
                </p>
                <div
                  className="shadow-lg absolute -bottom-4 right-4 !w-[200px] rounded-lg border border-stroke-soft-200 bg-bg-white-0 focus:outline-none focus-visible:outline-none sm:-bottom-20"
                  style={{ opacity: 1 }}
                >
                  <div className="max-h-none p-0 focus:outline-none focus-visible:ring-0">
                    <button
                      className="text-sm flex w-full cursor-pointer items-center justify-between gap-2 rounded-lg px-2 py-1 !text-primary-base hover:bg-primary-alpha-16 focus:outline-none focus-visible:ring-0 data-[selected=true]:bg-primary-alpha-10"
                      type="button"
                      style={{
                        transform: "none",
                        backgroundColor: "transparent",
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-paragraph-xs">Accept</span>
                      </div>
                      <kbd className="border-none bg-transparent p-0 text-paragraph-xs">
                        Tab
                      </kbd>
                    </button>
                    <button
                      className="text-sm flex w-full cursor-pointer items-center justify-between gap-2 rounded px-2 py-1 hover:bg-primary-alpha-16 focus:outline-none focus-visible:ring-0 data-[selected=true]:bg-primary-alpha-10"
                      type="button"
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-paragraph-xs">Previous</span>
                      </div>
                      <kbd className="border-none bg-transparent p-0 text-paragraph-xs">
                        ←
                      </kbd>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-paragraph-xs">Another</span>
                      </div>
                      <kbd className="border-none bg-transparent p-0 text-paragraph-xs">
                        →
                      </kbd>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span className="text-paragraph-xs">Discard</span>
                      </div>
                      <kbd className="border-none bg-transparent p-0 text-paragraph-xs">
                        Esc
                      </kbd>
                  ...
                  <div className="px-2 pb-1 text-right text-subheading-2xs text-text-sub-600">
                    1/5 suggestions
                  </div>
                </div>
              </div>
              <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-8 transition-all duration-300">
                ...
                <p className="max-w-lg text-text-sub-600">
                  One Key, unlimited power. Type Pulse offers suggestions based
                  on your document&apos;s context to prevent writer&apos;s
                  block.
                </p>
              </div>
              <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-[#fa7319]/[.024]"></div>
      ...
      <section
        id="chats"
        className="container mx-auto max-w-screen-md px-4 py-24 sm:px-0 sm:py-32 xl:max-w-screen-lg 2xl:max-w-screen-xl"
      >
        <h2 className="mb-2 text-center text-label-lg tracking-wider text-primary-base">
          MORE FEATURES
        </h2>
        ...
        <h3 className="text-xl mx-auto mb-8 text-center text-text-sub-600 md:w-1/2">
          Type Pulse is built to help you write faster and more efficiently.
        </h3>
            ...
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-atom text-primary-base"
                >
              ...
              <h3 className="text-title-h5 font-semibold leading-none">
                State-of-the-art AI Models
              </h3>
            </div>
            <div className="p-6 pt-0 text-text-sub-600">
              Use the latest AI Reasoning/Generative Models like Claude Sonnet
              4, GPT-5, and more.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-brain text-primary-base"
                >
              ...
              <h3 className="text-title-h5 font-semibold leading-none">
                Writing Agents Marketplace
              </h3>
            </div>
            <div className="p-6 pt-0 text-text-sub-600">
              Enhance your AI Writing workflows by using our AI Writing Agents.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-square-library text-primary-base"
                >
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Use prebuilt prompt templates to generate content fast.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-pocket-knife text-primary-base"
                >
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Use MCP tools to enhance your writing.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-command text-primary-base"
                >
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Access commands with a keyboard shortcut.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-moon text-primary-base"
                >
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Full dark mode support for late-night thinkers.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-keyboard text-primary-base"
                >
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Typing without mouse becomes ease.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-link text-primary-base"
                >
                  <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path>
                  <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path>
                </svg>
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Extract links from any website and use them as context.
            </div>
          </div>
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/50 dark:bg-card hover:bg-background group/number transition-all delay-75">
            <div className="flex-col space-y-1.5 p-6 flex items-start">
              <div className="mb-4 flex justify-between">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-file-text text-primary-base"
                >
                  <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path>
                  <path d="M14 2v4a2 2 0 0 0 2 2h4"></path>
                  <path d="M10 9H8"></path>
            ...
            <div className="p-6 pt-0 text-text-sub-600">
              Export your writing as markdown or PDF.
            </div>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <h2 className="text-white-to-orange-lighter mb-4 text-center font-serif text-title-h3 md:text-title-h2">
          For Those Who Want More Potential
        </h2>
        <h3 className="text-xl mx-auto mb-8 text-center text-text-sub-600 md:w-1/2">
          Most apps add so many features that make it difficult to just write.
          We don&apos;t alienate those who want a simple workflow. Type Pulse is
          built around one simple workflow, write, rewrite and thrive your
          content.
        </h3>
        <div className="mx-auto grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Write better newsletters, articles, scripts, essays, and posts.
              </p>
            </div>
            <div
              className="inline-flex items-center justify-center rounded-full transition duration-200 ease-out h-4 gap-1.5 px-2 text-subheading-2xs uppercase has-[&gt;.dot]:gap-2 text-static-white bg-warning-base absolute -right-3 -top-2"
              data-pro="false"
            >
              Coming Soon
            </div>
          ...
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Find the right ideas when you need them for books &amp;
                articles.
              </p>
            </div>
            <div
          ...
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Outline and draft emails, landing pages, and copywriting.
              </p>
            </div>
            <div
              className="inline-flex items-center justify-center rounded-full transition duration-200 ease-out h-4 gap-1.5 px-2 text-subheading-2xs uppercase has-[&gt;.dot]:gap-2 text-static-white bg-warning-base absolute -right-3 -top-2"
          ...
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Take notes, organize your digital life and have one place to
                save your ideas.
              </p>
            </div>
            <div
          ...
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Reference course material, take effective notes, and write
                compelling papers..
              </p>
            </div>
            <div
          ...
          <div className="text-card-foreground shadow-sm rounded-lg border border-stroke-soft-200 bg-muted/60 dark:bg-card relative h-full">
            ...
            <div className="flex flex-col space-y-1.5 p-6">
              ...
              <p className="text-sm text-text-sub-600">
                Collaborate on interconnected creative documents for better
                content.
              </p>
            </div>
            <div
      ...
      >
        ...
        <h2 className="text-white-to-orange-lighter mb-4 text-center font-serif text-title-h3 md:text-title-h2">
          Cultivate Your Writing Habits
        </h2>
        <h3 className="text-xl mx-auto mb-8 text-center text-text-sub-600 md:w-1/2">
          Using Type Pulse&apos;s AI Agents to help you write
        </h3>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <div className="text-card-foreground rounded-lg border-stroke-soft-200 bg-background h-full border-0 shadow-none">
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-badge-check text-primary-base"
                  >
              ...
              <div className="p-6 pt-0 text-left text-text-sub-600">
                <span>
                  Save hours writing your essay with our AI Writing Agents.
                </span>
              </div>
            </div>
          </div>
          <div>
            <div className="text-card-foreground rounded-lg border-stroke-soft-200 bg-background h-full border-0 shadow-none">
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-newspaper text-primary-base"
                  >
              ...
              <div className="p-6 pt-0 text-left text-text-sub-600">
                Write SEO-friendly blogs &amp; articles faster with the help of
                AI.
              </div>
            </div>
          </div>
          <div>
            <div className="text-card-foreground rounded-lg border-stroke-soft-200 bg-background h-full border-0 shadow-none">
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-trending-up text-primary-base"
                  >
              ...
              <div className="p-6 pt-0 text-left text-text-sub-600">
                Write compelling SEO content to grow your network and engage
                with your audience.
              </div>
            </div>
          </div>
          <div>
            <div className="text-card-foreground rounded-lg border-stroke-soft-200 bg-background h-full border-0 shadow-none">
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-thumbs-up text-primary-base"
                  >
              ...
              <div className="p-6 pt-0 text-left text-text-sub-600">
                Write your next engaging social media post to grow your
                audience.
              </div>
            </div>
          </div>
          <div>
            <div className="text-card-foreground rounded-lg border-stroke-soft-200 bg-background h-full border-0 shadow-none">
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-linkedin text-primary-base"
                  >
              ...
              <div className="p-6 pt-0 text-left text-text-sub-600">
                Write compelling LinkedIn posts to grow your network and engage
                with your audience.
              </div>
            </div>
          </div>
              ...
              <div className="flex-col space-y-1.5 p-6 flex items-start">
                <div className="mb-4 rounded-full bg-primary-alpha-16 p-2 ring-8 ring-primary-alpha-16">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-youtube text-primary-base"
                  >
      ...
      <section
        id="pricing"
        className="sm:py-38 container mx-auto max-w-screen-md px-4 py-24 xl:max-w-screen-lg 2xl:max-w-screen-xl"
      >
        <h2 className="mb-2 text-center text-label-lg tracking-wider text-primary-base">
          PRICING
        </h2>
        ...
        <h3 className="text-xl mx-auto pb-14 text-center text-text-sub-600 md:w-1/2">
        ...
        <div className="mx-auto mb-12 w-fit">
          <div dir="ltr" data-orientation="horizontal">
            <div
              role="tablist"
              aria-orientation="horizontal"
              className="relative isolate grid w-full auto-cols-fr grid-flow-col bg-bg-weak-50 gap-2 rounded-3xl p-2"
              tabIndex={0}
              data-orientation="horizontal"
              style={{ outline: "none" }}
            >
              <button
                ...
                role="tab"
                aria-selected="true"
                aria-controls="radix-:Rakv9ba:-content-Yearly"
                data-state="active"
                id="radix-:Rakv9ba:-trigger-Yearly"
                className="peer relative z-10 h-7 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950 w-24"
                tabIndex={-1}
                data-orientation="horizontal"
                data-radix-collection-item=""
              >
              ...
              <button
                ...
                role="tab"
                aria-selected="false"
                aria-controls="radix-:Rakv9ba:-content-Monthly"
                data-state="inactive"
                id="radix-:Rakv9ba:-trigger-Monthly"
                className="peer relative z-10 h-7 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950 w-24"
                tabIndex={-1}
                data-orientation="horizontal"
                data-radix-collection-item=""
              ...
              <div
                className="absolute inset-y-1 left-0 -z-10 rounded-3xl shadow-toggle-switch transition-transform duration-300 segmented-control-highlight"
                style={{
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-4">
            ...
            <div className="relative z-10 flex h-full w-full flex-col items-start justify-start">
              <div className="flex flex-col items-start justify-start gap-4">
                ...
                <p className="text-label-md text-text-sub-600">
                  For personal note-taking, writing, and creative work with
                  minimal AI features.
                </p>
              </div>
              <div className="my-5 inline-flex items-end justify-start gap-1 self-stretch">
                ...
                <div className="flex items-center justify-center gap-2.5 pb-3">
                  <div className="justify-center text-paragraph-sm font-medium leading-tight text-text-sub-600">
                    /MONTH
                  </div>
                </div>
              </div>
              ...
              <div className="my-5 flex flex-col items-start justify-start gap-2.5 self-stretch">
                <div className="mb-2 flex flex-col items-start justify-start gap-2.5 self-stretch">
                  Free plan includes:
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-white/10">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-check relative size-3"
                    >
                      <path d="M20 6 9 17l-5-5"></path>
                    </svg>
                  </div>
                  <div className="text-sm lg:text-base justify-center font-normal leading-normal text-text-strong-950">
                    100 Basic AI models requests per month
                  </div>
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-white/10">
                ...
                <div className="inline-flex items-center justify-start gap-2.5">
                  ...
                  <div className="text-sm lg:text-base justify-center font-normal leading-normal text-text-strong-950">
                    5MB file upload, 200 MB storage
                  </div>
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-white/10">
          ...
          <div className="bg-neutral-900/50 relative inline-flex flex-col items-start justify-start overflow-hidden rounded-2xl border border-stroke-soft-200 p-5">
            ...
            <div className="relative z-10 flex h-full w-full flex-col items-start justify-start">
              <div className="flex flex-col items-start justify-start gap-4">
                <h3 className="text-label-lg font-semibold text-primary-neon">
                  Creator
                </h3>
                <p className="text-label-md text-text-sub-600">
                  Perfect for growing teams that need more power and
                  flexibility.
                </p>
              </div>
              <div className="my-5 inline-flex items-end justify-start gap-1 self-stretch">
                ...
                <div className="flex items-center justify-center gap-2.5 pb-3">
                  ...
                  <div className="text-paragraph-sm font-medium leading-tight text-text-sub-600">
                    (Save 25%)
                  </div>
                </div>
              </div>
              ...
              <div className="my-5 flex flex-col items-start justify-start gap-2.5 self-stretch">
                ...
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-primary-alpha-10">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-check relative size-3 font-semibold text-primary-base"
                    >
                      <path d="M20 6 9 17l-5-5"></path>
                    </svg>
                  </div>
                  <div className="text-sm lg:text-base justify-center font-normal leading-normal text-text-strong-950">
                    Unlimited Basic AI models requests
                  </div>
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-primary-alpha-10">
                ...
                <div className="inline-flex items-center justify-start gap-2.5">
                  ...
                  <div className="text-sm lg:text-base justify-center font-normal leading-normal text-text-strong-950">
                    Browser extension access (coming soon)
                  </div>
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-primary-alpha-10">
          ...
          <div className="bg-neutral-900/50 relative inline-flex flex-col items-start justify-start overflow-hidden rounded-2xl border border-stroke-soft-200 p-5">
            ...
            <div className="relative z-10 flex h-full w-full flex-col items-start justify-start">
              <div className="flex flex-col items-start justify-start gap-4">
                ...
                <p className="text-label-md text-text-sub-600">
                  For those need much higher AI usage limits, priority support.
                </p>
              </div>
              <div className="my-5 inline-flex items-end justify-start gap-1 self-stretch">
                <div className="justify-center font-serif font-bold text-text-strong-950">
              ...
              <div className="my-5 flex flex-col items-start justify-start gap-2.5 self-stretch">
                ...
                <div className="inline-flex items-center justify-start gap-2.5">
                  ...
                  <div className="text-sm lg:text-base justify-center font-normal leading-normal text-text-strong-950">
                    Unlimited files upload, 10 GB storage
                  </div>
                </div>
                <div className="inline-flex items-center justify-start gap-2.5">
                  <div className="flex h-5 w-5 items-start justify-start gap-3 rounded-[125px] p-[5px] bg-primary-alpha-10">
        ...
        <div className="mt-12 flex justify-center">
          <div className="group flex items-center gap-1 text-paragraph-xs text-text-sub-600">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-info size-4 shrink-0 text-text-soft-400"
            >
      ...
      <section
        id="faq"
        className="container mx-auto max-w-screen-md px-4 py-24 sm:px-0 sm:py-32"
      >
        <div className="mb-8 text-center">
          <h2 className="mb-2 text-center text-label-lg tracking-wider text-primary-base">
            FAQS
          </h2>
          <h2 className="text-white-to-orange-lighter text-center font-serif text-title-h3 md:text-title-h2">
        ...
        <div className="w-full">
          <div className="space-y-6" data-orientation="vertical">
            <div
              ...
              className="group/accordion rounded-10 bg-bg-white-0 p-3.5 ring-1 ring-inset ring-stroke-soft-200 transition duration-200 ease-out hover:bg-bg-weak-50 hover:ring-transparent has-[:focus-visible]:bg-bg-weak-50 has-[:focus-visible]:ring-transparent data-[state=open]:bg-bg-weak-50 data-[state=open]:ring-transparent"
            >
              <button
                type="button"
                aria-controls="radix-:R8qsv9ba:"
                aria-expanded="false"
                data-state="closed"
                data-orientation="vertical"
                id="radix-:Rqsv9ba:"
                className="w-[calc(100%+theme(space.7))] text-left text-label-sm text-text-strong-950 grid auto-cols-auto grid-flow-col grid-cols-[auto,minmax(0,1fr)] items-center gap-2.5 -m-3.5 p-3.5 outline-none focus:outline-none"
                data-radix-collection-item=""
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-plus size-5 text-text-soft-400 transition duration-200 ease-out group-hover/accordion:text-text-sub-600 group-data-[state=open]/accordion:hidden"
                >
                  <path d="M5 12h14"></path>
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-minus size-5 text-text-sub-600 hidden group-data-[state=open]/accordion:block"
                >
                  <path d="M5 12h14"></path>
                </svg>
              </button>
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R1asv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R1qsv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R2asv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R2qsv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R3asv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R3qsv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R4asv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
            ...
            >
              ...
              <div
                ...
                hidden
                role="region"
                aria-labelledby="radix-:R4qsv9ba:"
                data-orientation="vertical"
                className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
                style={
                  {
      ...
      <div className="w-screen overflow-hidden bg-bg-white-0">
        <div className="relative mx-auto h-[360px] w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] md:w-4/5">
          <div
            id=":Rn4v9ba:"
            className="absolute inset-x-0 top-0 h-full w-full [mask-image:radial-gradient(50%_50%,#FA7319,transparent_85%)] dark:[mask-image:radial-gradient(50%_50%,white,transparent_85%)]"
          >
            <canvas
              data-generated="true"
        ...
        <article className="relative z-10 mx-auto block w-2/3 py-2 text-center text-text-strong-950">
          <h2 className="text-white-to-orange-lighter mb-4 text-center font-serif text-title-h3 md:text-title-h2">
            Your Vibe Writing Journey Begins Here
          </h2>
          <h3 className="text-xl mx-auto mb-8 text-center text-text-sub-600 md:w-1/2">
            Write with Type Pulse today and never look back
          </h3>
      ...
      <footer
        id="footer"
        className="relative mt-20 flex h-full w-full flex-col overflow-hidden"
      >
        <div className="container z-10 mx-auto max-w-screen-md px-4 py-4 sm:px-0 sm:py-32 xl:max-w-screen-lg 2xl:max-w-screen-xl">
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-b from-orange-alpha-24 to-orange-alpha-10 p-6 md:p-10">
            <div
              className="pointer-events-none absolute left-0 top-0 z-10 h-full w-full rounded-2xl bg-[url('/noise.gif')] content-['']"
              style={{ opacity: 0.025 }}
            ></div>
            <div className="grid grid-cols-2 gap-x-12 gap-y-8 md:grid-cols-3 xl:grid-cols-5">
              <div className="col-span-full flex flex-col gap-2 xl:col-span-2">
                ...
                <p className="mt-4 text-text-strong-950">
                  Meet your AI writing agents for content creation.
                </p>
                <div className="flex gap-3 lg:items-center">
                  <a
                    href="https://twitter.com/typepulse_ai"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://bsky.app/profile/typepulse.ai"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-text-sub-600 hover:text-text-strong-950"
                  >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <a
                    ...
                    href="/tools/seo-outline-generator"
                  >
                ...
                <div>
                  <a
                    className="opacity-60 hover:opacity-100"
                    href="/tools/reddit-comment-agent"
                  >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <a className="opacity-60 hover:opacity-100" href="/blog">
                    Blog
                  </a>
                </div>
                <div>
                  <a className="opacity-60 hover:opacity-100" href="#faqs">
                    FAQs
                  </a>
                </div>
                <div>
                  <a
                    className="opacity-60 hover:opacity-100"
                    href="https://typepulse.featurebase.app/roadmap"
                  >
                    Roadmap
                  </a>
                </div>
                <div>
                  <a
                    className="opacity-60 hover:opacity-100"
                    href="https://typepulse.featurebase.app/help"
                  >
                    Help Center
                  </a>
                </div>
                <div>
                  <a
                    className="opacity-60 hover:opacity-100"
                    href="mailto:support@typepulse.ai"
                  >
                    Contact
                  </a>
                </div>
                <div>
                  <a className="opacity-60 hover:opacity-100" href="/privacy">
                    Privacy Policy
                  </a>
                </div>
                <div>
                  <a className="opacity-60 hover:opacity-100" href="/terms">
                    Terms of Service
                  </a>
                </div>
                <div dir="ltr" data-orientation="horizontal">
                  <div
                    role="tablist"
                    aria-orientation="horizontal"
                    className="relative isolate grid auto-cols-fr grid-flow-col p-1 w-fit gap-2 rounded-full bg-transparent"
                    tabIndex={0}
                    data-orientation="horizontal"
                    style={{ outline: "none" }}
                  >
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:R9h7cv9ba:-content-light"
                      data-state="inactive"
                      id="radix-:R9h7cv9ba:-trigger-light"
                      className="peer relative z-10 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950 aspect-square h-6"
                      tabIndex={-1}
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    >
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:R9h7cv9ba:-content-dark"
                      data-state="inactive"
                      id="radix-:R9h7cv9ba:-trigger-dark"
                      className="peer relative z-10 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950 aspect-square h-6"
                      tabIndex={-1}
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="true"
                      aria-controls="radix-:R9h7cv9ba:-content-system"
                      data-state="active"
                      id="radix-:R9h7cv9ba:-trigger-system"
                      className="peer relative z-10 whitespace-nowrap rounded-md px-1 text-label-sm text-text-soft-400 outline-none flex items-center justify-center gap-1.5 transition duration-300 ease-out focus:outline-none data-[state=active]:text-text-strong-950 aspect-square h-6"
                      tabIndex={-1}
                      data-orientation="horizontal"
                      data-radix-collection-item=""
                    ...
                    <div
                      className="absolute inset-y-1 left-0 -z-10 shadow-toggle-switch transition-transform duration-300 rounded-full p-2"
                      style={{
            ...
            <div
              data-orientation="horizontal"
              role="none"
              className="bg-border shrink-0 h-[1px] w-full my-6"
            ></div>
            <section className="flex w-full items-center justify-between">
              <h3>
                Copyright © 2025
                <div className="ml-1 inline-block text-primary-base">
                  CursorDance, LLC
                </div>{" "}
                All Rights Reserved.
              </h3>
