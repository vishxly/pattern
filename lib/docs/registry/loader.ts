...
import {
  ...
  LoaderDirectImportsExample,
} from "@/lib/docs/components/example/loader";

export const loaderRegistry: ComponentGroup = {
  name: "loaderRegistry",
  title: "Loader",
  description:
    "A customizable loader component with several variants to indicate loading states.",
  category: "components",
  components: ["LoaderDemo"],
  // Installation configuration
  installation: {
    cliCommand: 'npx shadcn@latest add "https://zeroui.vercel.app/r/loader"',
...
export function cn(...inputs: ClassValue[]) {
  ...
  props: [
    {
      name: "variant",
      type: "'default' | 'circle' | 'pinwheel' | 'circle-filled' | 'ellipsis' | 'ring' | 'bars' | 'infinite' | 'pulse' | 'bounce'",
      description: "The variant of the loader to display.",
      required: false,
      default: "default",
    },
    {
    ...
    },
    {
      name: "color",
      type: "string",
      description: "The color of the loader. Defaults to 'currentColor'.",
      required: false,
    },
    {
      name: "speed",
      type: "'slow' | 'normal' | 'fast'",
      description: "The animation speed of the loader.",
      required: false,
      default: "normal",
    },
    {
      name: "className",
      type: "string",
      description: "Additional CSS classes for styling the loader container.",
      required: false,
    },
    {
      name: "aria-label",
  ...
  examples: [
    {
      ...
      description: "Showcasing different loader variants.",
...
export const LoaderVariantsExample = () => {
  return (
    ...
    {
      title: "Loader Direct Imports",
      description: " Direct imports of specific loader variants.",
      component: LoaderDirectImportsExample,
      code: `
"use client";
import {
  Loader,
...
export const LoaderDirectImportsExample = () => {
  ...
  variants: {
    basic: {
      title: "Loader",
      description:
        "A loader component that can be used to display content in a layer above the main content.",
      component: LoaderDemo,
      image: "/images/components/loader-basic.png",
      fallbackImage:
        "/placeholder.svg?height=300&width=400&text=Interactive+Loader",
      code: `"use client";
