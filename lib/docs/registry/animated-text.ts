...
import AnimatedTextDemo from "../components/animated-text";

export const animatedTextRegistry: ComponentGroup = {
  name: "animatedTextRegistry",
  title: "Animated Text",
  description:
    "A collection of beautiful text animations inspired by shadcn/ui.",

  category: "components",
  components: ["AnimatedTextDemo"],
  // Installation configuration
  installation: {
    cliCommand:
      'npx shadcn@latest add "https://zeroui.vercel.app/r/animated-text"',
    dependencies: ["clsx", "tailwind-merge"],
    componentPath: "components/ui/animated-text.tsx",
...
export function cn(...inputs: ClassValue[]) {
  ...
  props: [
    ...
    {
      name: "variant",
      type: `"mouseReveal" | "wave" | "glow" | "typewriter" | "bounce" | "rainbow" | "glitch" | "neon" | "dissolve" | "matrix"`,
      description: "The animation variant to apply to the text.",
      required: false,
    },
    {
      name: "fontSize",
      type: "string",
      description: "Specifies the font size of the animated text.",
      required: false,
    },
  ],
  ...
  variants: {
    basic: {
      title: "Mouse Reveal Animation",
      description:
        "An interactive text effect where the animation responds to mouse movement.",
      component: AnimatedTextDemo,
      image: "/images/components/animated-text.png",
      fallbackImage: "/placeholder.svg?height=300&width=400&text=Animated+Text",
      code: `"use client";
...
`,
      manualCode: `import React, { useState, useEffect } from "react";
