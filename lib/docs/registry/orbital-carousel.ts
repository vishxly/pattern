...
import CarouselDemo from "../components/orbital-carousel";

export const carouselRegistry: ComponentGroup = {
  name: "carouselRegistry",
  title: "Carousel",
  description:
    "Displays a carousel of images with pagination and navigation controls.",
  category: "components",
  components: ["CardCarousel"],
  installation: {
    cliCommand: 'npx shadcn@latest add "https://zeroui.vercel.app/r/carousel"',
    dependencies: ["clsx", "tailwind-merge", "lucide-react", "framer-motion"],
    componentPath: "components/zeroui/carousel.tsx",
    utilsCode: ``,
  },
  props: [
    {
      ...
      description:
        "An array of image objects to display in the carousel. The title property is optional.",
      required: false,
    },
    {
      name: "autoplayDelay",
      type: "number",
      description:
        "The delay in milliseconds for autoplay. Set to 0 to disable autoplay.",
      default: "5000",
      required: false,
    },
    {
  ...
  variants: {
    basic: {
      title: "Card Carousel",
      description: "A responsive card carousel with a 3D perspective effect.",
      component: CarouselDemo,
      image: "/images/card-carousel.png",
      fallbackImage: "/images/fallback-carousel.png",
      ...
      <div className="max-w-7xl mx-auto py-12 px-4">
        ...
        <OrbitalCarousel
          images={[
            ...
            {
              src: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=400&h=550&fit=crop",
              alt: "Verdant Valley",
            ...
            {
              src: "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=400&h=550&fit=crop",
