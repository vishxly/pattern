...
export const spotlightRegistry: ComponentGroup = {
  name: "Spotlight",
  title: "Spotlight Card",
  description:
    "A set of cards that reveal a glowing spotlight effect on hover, perfect for highlighting features or products.",
  category: "components",
  components: ["SpotlightDemo"],
  installation: {
    cliCommand: "npx shadcn@latest add \"https://zeroui.vercel.app/r/spotlight\"",
