...
export const timelineRegistry: ComponentGroup = {
  name: "timelineRegistry",
  title: "Timeline",
  description: "A vertical timeline component to display chronological events.",
  category: "components",
  components: ["TimelineDemo"],
    // Installation configuration
  installation: {
    cliCommand: "npx shadcn@latest add \"https://zeroui.vercel.app/r/timeline\"",
...
export function cn(...inputs: ClassValue[]) {
  ...
  variants: {
    basic: {
      ...
      description:
        "A timeline for showcasing a sequence of events with titles, descriptions, and icons.",
