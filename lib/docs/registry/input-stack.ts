...
import CascadeDemo from "../components/cascade-input";

export const cascadeInputRegistry: ComponentGroup = {
  name: "cascadeInputRegistry",
  title: "Cascade Input",
  description: "A modern multi-step form component for collecting user input.",
  category: "components",
  components: ["CascadeInput"],
  // Installation configuration
  installation: {
    cliCommand:
      'npx shadcn@latest add "https://zeroui.vercel.app/r/cascade-input"',
    dependencies: ["clsx", "tailwind-merge", "framer-motion", "lucide-react"],
    componentPath: "components/ui/cascade-input.tsx",
...
export function cn(...inputs: ClassValue[]) {
  ...
  props: [
    {
      name: "steps",
      type: "CascadeInputStep[]",
      description:
        "An array of configuration objects, each defining a step in the form.",
      required: true,
    },
    {
      name: "onComplete",
      ...
      description:
        "Callback function triggered when the final step is completed.",
      required: false,
    },
    {
      name: "onStepChange",
      type: "(step: number, data: Record<string, string>) => void",
      description:
        "Callback function triggered whenever data in the current step changes.",
      required: false,
    },
    {
      name: "className",
    ...
    },
    {
      ...
      type: "string",
      description: "The height of the component container.",
      required: false,
    },
    {
      name: "cardWidth",
      type: "string",
      description: "The width of the individual step cards.",
      required: false,
    },
    {
      name: "cardMaxWidth",
      type: "string",
      description: "The maximum width of the individual step cards.",
      required: false,
    },
    {
      name: "cardMinWidth",
      type: "string",
      description: "The minimum width of the individual step cards.",
      required: false,
    },
    {
      name: "showProgressDots",
      type: "boolean",
      description: "Toggles the visibility of the progress dots at the bottom.",
      required: false,
    },
  ],
  ...
  variants: {
    basic: {
      ...
      description:
        "A fluid, multi-step form that guides users through a process, with a liquid glass aesthetic.",
      component: CascadeDemo,
      image: "/images/components/cascade-input-basic.png",
      fallbackImage: "/placeholder.svg?height=300&width=400&text=Cascade+Input",
      code: `"use client";
