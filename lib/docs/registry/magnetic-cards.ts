...
import MagneticCardsDemo from "../components/magnetic-cards";

export const magneticCardsRegistry: ComponentGroup = {
  name: "magneticCardsRegistry",
  title: "Magnetic Cards",
  description:
    "Interactive cards with magnetic attraction effects. Hover over cards to see them respond to your cursor with realistic physics-based animations.",

  category: "components",
  components: ["MagneticCardsDemo"],
  // Installation configuration
  installation: {
    cliCommand: "npx shadcn@latest add \"https://zeroui.vercel.app/r/magnetic-cards\"",
    dependencies: ["clsx", "tailwind-merge", "lucide-react"],
    componentPath: "components/zeroui/magnetic-cards.tsx",
  ...
  props: [
    {
      name: "cards",
      type: "MagneticCard[]",
      description: "An array of card objects to be displayed.",
      required: true,
    },
    {
      name: "className",
      type: "string",
      description:
        "Additional CSS classes for styling the container of the cards.",
      required: false,
    },
    {
      name: "cardClassName",
      type: "string",
      description:
        "Additional CSS classes for styling individual card components.",
      required: false,
    },
    {
      ...
      type: "number",
      description:
        "Controls the strength of the magnetic attraction. Higher values result in stronger attraction.",
      required: false,
    },
    {
      name: "maxDistance",
      type: "number",
      description:
        "The maximum distance (in pixels) from the cursor at which the magnetic effect is active.",
      required: false,
    },
    {
      name: "onCardClick",
      type: "(card: MagneticCard) => void",
      description: "Callback function that is invoked when a card is clicked.",
      required: false,
    },
  ],
