...
export const folderRegistry: ComponentGroup = {
  name: "folderRegistry",
  title: "Folder",
  description: "A dynamic and interactive folder component inspired by macOS, allowing for nested file and sub-folder exploration in a modal view.",
  category: "components",
  components: ["FolderDemo"],
  installation: {
    cliCommand: "npx shadcn@latest add folder",
    dependencies: ["framer-motion", "lucide-react"],
    componentPath: "components/ui/folder.tsx",
    utilsCode: ""
  },
  props: [
    {
      name: "folder",
      type: "FolderItem",
      description: "The data object for the folder, containing its structure and children (files or other folders).",
      required: true
    },
    {
      name: "className",
      type: "string",
      description: "Additional CSS classes for styling the main folder container.",
      required: false
    }
  ],
  variants: {
    basic: {
      title: "Interactive macOS-style Folder",
      description: "A folder component that opens a modal to explore its contents. Supports nested folders, various file types, grid/list views, search, and downloads.",
      component: FolderDemo,
      image: "/images/components/folder-basic.png",
      fallbackImage: "/placeholder.svg?height=300&width=400&text=Interactive+Folder",
